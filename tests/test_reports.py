...
@mock_backend_response({"diagnostics": {"list_diagnostics": {"diagnostics": [{"diag_id": "1234"}]}}})
...
@mock_backend_response({"diagnostics": {"list_diagnostics": {"diagnostics": [{"diag_id": "5678"}]}}})
...
@mock_backend_response(
    {"diagnostics": {"list_diagnostics": {"diagnostics": [{"diag_id": "5678", "status": "pending"}]}}}
)
